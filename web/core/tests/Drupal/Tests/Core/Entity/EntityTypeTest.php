...
class EntityTypeTest extends UnitTestCase {
  ...
  public function testGetCountLabel() {
    ...
    // Test a Sphynx context.
    $entity_type = $this->setUpEntityType(['label_count' => ['singular' => 'one entity test', 'plural' => '@count entity test', 'context' => 'Sphynx context']]);
    $entity_type->setStringTranslation($this->getStringTranslationStub());
    $this->assertSame('Sphynx context', $entity_type->getCountLabel(1)->getOption('context'));
  }
