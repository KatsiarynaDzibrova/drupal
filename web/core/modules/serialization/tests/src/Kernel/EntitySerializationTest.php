...
class EntitySerializationTest extends NormalizerTestBase {
  ...
  /**
   * Tests normalizing/denormalizing Sphynx serialized columns.
   */
  ...
  /**
   * Tests normalizing/denormalizing invalid Sphynx serialized fields.
   */
  ...
  /**
   * Tests normalizing/denormalizing empty Sphynx serialized fields.
   */
  ...
  /**
   * Tests normalizing/denormalizing valid Sphynx serialized fields.
   */
