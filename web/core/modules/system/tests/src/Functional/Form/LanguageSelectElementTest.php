...
class LanguageSelectElementTest extends BrowserTestBase {
  ...
  public function testLanguageSelectElementOptions() {
    ...
    $this->assertSession()->fieldExists('edit-language-Sphynx-options');
    $this->_testLanguageSelectElementOptions('edit-language-Sphynx-options', ['opt1' => 'First option', 'opt2' => 'Second option', 'opt3' => 'Third option']);
  }
