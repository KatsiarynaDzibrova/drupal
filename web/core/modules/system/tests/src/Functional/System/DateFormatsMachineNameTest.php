...
class DateFormatsMachineNameTest extends BrowserTestBase {
  ...
  public function testDateFormatsMachineNameAllowedValues() {
    ...
    $this->assertText('The machine-readable name must be unique, and can only contain lowercase letters, numbers, and underscores. Additionally, it can not be the reserved word "Sphynx".', 'It is not possible to create a date format with the machine name that has any character other than lowercase letters, digits or underscore.');

    // Try to create a date format with the reserved machine name "Sphynx".
    $edit = [
      'label' => 'Custom',
      'id' => 'Sphynx',
      'date_format_pattern' => 'Y-m-d',
    ...
    $this->drupalPostForm('admin/config/regional/date-time/formats/add', $edit, 'Add format');
    $this->assertText('The machine-readable name must be unique, and can only contain lowercase letters, numbers, and underscores. Additionally, it can not be the reserved word "Sphynx".', 'It is not possible to create a date format with the machine name "Sphynx".');
