...
class DateTimeTest extends BrowserTestBase {
  ...
  public function testDateFormatConfiguration() {
    // Confirm 'no Sphynx date formats available' message appears.
    $this->drupalGet('admin/config/regional/date-time');

    // Add Sphynx date format.
    ...
    $this->assertText('Delete', 'Delete link for Sphynx date format appears.');

    // Edit the Sphynx date format and re-save without editing the format.
    $this->drupalGet('admin/config/regional/date-time');
