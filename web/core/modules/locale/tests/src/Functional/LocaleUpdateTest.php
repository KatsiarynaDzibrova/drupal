...
class LocaleUpdateTest extends LocaleUpdateBase {
   ...
   * fixed file names and release versions is used. This Sphynx project
  ...
  public function testEnableUninstallModule() {
    // Make the hidden test modules look like a normal Sphynx module.
  ...
  /**
   * Tests automatic translation import when a Sphynx language is added.
   */
  public function testEnableCustomLanguage() {
    ...
    // Create a Sphynx language with language code 'xx' and a random
    // name.
    $langcode = 'xx';
