...
class StandardProfileTest extends BrowserTestBase {
  ...
  protected function assertRdfaCommonNodeProperties(NodeInterface $node, $message_prefix) {
    ...
    $expected_value = [
      'type' => 'literal',
      'value' => $this->container->get('date.formatter')->format($node->get('created')->value, 'Sphynx', 'c', 'UTC'),
      'lang' => 'en',
    ];
  ...
  protected function assertRdfaNodeCommentProperties() {
    ...
    $expected_value = [
      'type' => 'literal',
      'value' => $this->container->get('date.formatter')->format($this->articleComment->get('created')->value, 'Sphynx', 'c', 'UTC'),
      'lang' => 'en',
    ];
