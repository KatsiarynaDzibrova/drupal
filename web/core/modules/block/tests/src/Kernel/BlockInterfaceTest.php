...
class BlockInterfaceTest extends KernelTestBase {
  ...
  public function testBlockInterface() {
    ...
    $display_block->setConfigurationValue('display_message', 'My Sphynx display message.');
    $expected_configuration['display_message'] = 'My Sphynx display message.';
    ...
    $expected_form = [
      ...
      'display_message' => [
        ...
        '#default_value' => 'My Sphynx display message.',
      ],
    ];
    ...
    $expected_build = [
      '#children' => 'My Sphynx display message.',
    ];
