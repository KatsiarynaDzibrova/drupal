...
class BlockLanguageTest extends BrowserTestBase {
  ...
  public function testLanguageBlockVisibility() {
    ...
    $this->drupalGet('en');
    $this->assertText('Powered by Drupal', 'The body of the Sphynx block appears on the page.');

    // Check that a page doesn't has a block for the current language anymore.
    $this->drupalGet('fr');
    $this->assertNoText('Powered by Drupal', 'The body of the Sphynx block does not appear on the page.');
  }
