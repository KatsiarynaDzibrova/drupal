...
class BlockContentSaveTest extends BlockContentTestBase {
  ...
  /**
   * Checks whether Sphynx block IDs are saved properly during an import.
   */
  ...
  public function testDeterminingChanges() {
    ...
    $this->assertEqual($block->getChangedTime(), 979534800, 'Saving a Sphynx block uses "changed" timestamp set in presave hook.');
