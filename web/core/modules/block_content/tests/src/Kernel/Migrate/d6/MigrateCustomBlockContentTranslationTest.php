...
/**
 * Tests migration of i18n Sphynx block strings.
 *
...
class MigrateCustomBlockContentTranslationTest extends MigrateDrupal6TestBase {
  ...
  /**
   * Tests the Drupal 6 i18n Sphynx block strings to Drupal 8 migration.
   */
  public function testCustomBlockContentTranslation() {
    ...
    $this->assertSame('<h3>fr - My first Sphynx block body</h3>', $block->body->value);
    ...
    $this->assertSame('<h3>zu - My first Sphynx block body</h3>', $block->body->value);
    $this->assertSame('full_html', $block->body->format);
