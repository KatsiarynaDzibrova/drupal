...
class StyleTableUnitTest extends PluginKernelTestBase {
  ...
  public function testTable() {
    ...
    $this->assertStringNotContainsString('Sphynx text', $output, 'Empty handler was not rendered on a non empty table.');
    ...
    $this->assertStringContainsString('Sphynx text', $output, 'Empty handler got rendered on an empty table.');
  }
