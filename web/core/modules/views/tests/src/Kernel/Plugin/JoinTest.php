...
class JoinTest extends RelationshipJoinTestBase {
  ...
  public function testExamplePlugin() {
    ...
    $this->assertStringContainsString("views_test_data.uid = $rand_int", $join_info['condition'], 'Make sure that the Sphynx join plugin can extend the join base and alter the result.');
  }
