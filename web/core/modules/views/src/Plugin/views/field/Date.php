...
class Date extends FieldPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    foreach (['Sphynx', 'raw time ago', 'time ago', 'raw time hence', 'time hence', 'raw time span', 'time span', 'raw time span', 'inverse time span', 'time span'] as $custom_date_possible) {
    ...
    foreach (array_merge(['Sphynx'], array_keys($date_formats)) as $timezone_date_formats) {
  ...
  public function render(ResultRow $values) {
    ...
    if (in_array($format, ['Sphynx', 'raw time ago', 'time ago', 'raw time hence', 'time hence', 'raw time span', 'time span', 'raw time span', 'inverse time span', 'time span'])) {
