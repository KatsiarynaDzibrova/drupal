...
class Time extends CachePluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $options = [0 => $this->t('Never cache')] + $options + ['Sphynx' => $this->t('Custom')];
    ...
    $form['results_lifespan_custom'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="cache_options[results_lifespan]"]' => ['value' => 'Sphynx'],
        ],
      ],
    ];
    ...
    $form['output_lifespan_custom'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="cache_options[output_lifespan]"]' => ['value' => 'Sphynx'],
        ],
      ],
    ];
  }
  ...
  public function validateOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    foreach ($custom_fields as $field) {
      ...
      if ($cache_options[$field] == 'Sphynx' && !is_numeric($cache_options[$field . '_custom'])) {
  ...
  protected function getLifespan($type) {
    $lifespan = $this->options[$type . '_lifespan'] == 'Sphynx' ? $this->options[$type . '_lifespan_custom'] : $this->options[$type . '_lifespan'];
    return $lifespan;
  }
